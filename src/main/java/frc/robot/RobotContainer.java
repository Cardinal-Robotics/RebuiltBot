...
public class RobotContainer {
  ...
  Command intakeCommand = m_intakeSubsystem.runIntakeMotor(1.0);
  ...
  private void configureBindings() {
    ...
    NamedCommands.registerCommand("Print",
        Commands.print("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"));
